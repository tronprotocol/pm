...
| Network  | Date  |  Status | Fork |  
|---------|------------|-----|-----|
| [Nile](https://github.com/tron-nile-testnet/nile-testnet) | 03/17/2025 | Upgraded to GreatVoyage-v4.8.0 （Kant） | Forked (Enabled No.83, No.88, No.89 Network Parameters)|
| Shasta  | later than 04/25/2025 (TBD) | GreatVoyage-v4.7.7(Epicurus) | - |  
| Mainnet | later than 04/22/2025 (TBD) | GreatVoyage-v4.7.7(Epicurus) | - |   
